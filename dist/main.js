...
class TaskList {
  ...
  static addNewTask = function (newTask) {
    ...
    _Storage_js__WEBPACK_IMPORTED_MODULE_0__["default"].updateStorage(TaskList.rawTaskArray);
  };
  ...
  static DisplayFunctions = (function () {
    ...
    const displayTask = (function () {
      const displayById = function (taskId) {
        ...
        _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].rawTaskArray.forEach((task) => {
          if (task.id == _taskId) {
    ...
    const createEditForm = function (task) {
      ...
      const taskObjArr = _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].rawTaskArray.filter((task) => {
        if (task.id === taskId) {
          return task;
        }
      });
      ...
      confirmTaskBtn.addEventListener("click", function (e) {
        ...
        const taskArr = _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].rawTaskArray.filter((task) => {
          if (taskId === task.id) {
            return task;
          }
        });
    ...
    const refreshProjectsInForm = function () {
      ...
      _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].rawTaskArray.forEach((el) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  taskList.forEach((task) => {
    _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"].DisplayFunctions.displayTask.displayByObj(task);
