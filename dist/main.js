  ...
  static DisplayController = (function () {
    ...
    const addModalEventListeners = function () {
      ...
      taskForm.addEventListener("submit", function (e) {
        ...
        _TaskList__WEBPACK_IMPORTED_MODULE_1__["default"].addNewTask(curTask);
  ...
  static DisplayFunctions = (function () {
    ...
    const displayTask = (function () {
      const displayById = function (taskId) {
        ...
        _TaskList__WEBPACK_IMPORTED_MODULE_1__["default"].rawTaskArray.forEach((task) => {
          if (task.id == _taskId) {
      ...
      const displayInDates = function (taskObj) {
        ...
        const curDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "yyyy, MM, d")
          .split(",")
          .map((str) => Number(str));
        const newTask = () => {
          const taskContainer = document.createElement("div");
    ...
    const createEditForm = function (task) {
      ...
      const taskObjArr = _TaskList__WEBPACK_IMPORTED_MODULE_1__["default"].rawTaskArray.filter((task) => {
        if (task.id === taskId) {
          return task;
        }
      });
      ...
      confirmTaskBtn.addEventListener("click", function (e) {
        ...
        const taskArr = _TaskList__WEBPACK_IMPORTED_MODULE_1__["default"].rawTaskArray.filter((task) => {
          if (taskId === task.id) {
            return task;
          }
        });
    ...
    const refreshProjectsInForm = function () {
      ...
      _TaskList__WEBPACK_IMPORTED_MODULE_1__["default"].rawTaskArray.forEach((el) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  _modules_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"].rawTaskArray.forEach((task) => {
