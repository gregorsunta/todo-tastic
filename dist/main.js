...
class TaskList {
  static taskArray = _Storage_js__WEBPACK_IMPORTED_MODULE_0__["default"].getStorage("taskList");
  static addNewTask = function (newTask) {
    const newId = TaskList.taskArray.length + 1;
    newTask.id = newId;
    TaskList.taskArray.push(newTask);
    _Storage_js__WEBPACK_IMPORTED_MODULE_0__["default"].updateStorage(TaskList.taskArray);
  };
...
class UI {
  static DisplayController = (function () {
    ...
    const addModalEventListeners = function () {
      ...
      taskForm.addEventListener("submit", function (e) {
        ...
        const curTask = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](...taskInput);
        _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].addNewTask(curTask);

        _Project__WEBPACK_IMPORTED_MODULE_3__["default"].addNewProject();
        taskForm.reset();
  ...
  static DisplayFunctions = (function () {
    const taskArr = _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].getStorage("taskList");
    ...
    const displayTask = (function () {
      ...
      const createTask = function (taskObj) {
        ...
        taskDeleteIcon.addEventListener("click", function (e) {
          ...
          const task = _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].taskArray.find(({ id }) => {
            return id === taskId;
          });
          removeTaskById(taskId);
          _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].removeTask(task);
        });
      ...
      const displayInDates = function (taskObj) {
        ...
        const curDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy, MM, d")
          .split(",")
          .map((str) => Number(str));
        const newTask = () => {
          const taskContainer = document.createElement("div");
    ...
    const createEditForm = function (taskEl) {
      ...
      confirmTaskBtn.addEventListener("click", function (e) {
        ...
        const updatedTask = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](...taskInputArr);
        const taskObj = taskArr.find(({ id }) => {
          return id === taskId;
        });
        removeTaskById(taskObj.id);
        _TaskList__WEBPACK_IMPORTED_MODULE_2__["default"].editTask(taskObj, updatedTask);
...
document.addEventListener("DOMContentLoaded", function () {
  _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"].DisplayController.addMainEventListeners();
  _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"].DisplayController.addModalEventListeners();
  const taskList = _modules_Storage_js__WEBPACK_IMPORTED_MODULE_3__["default"].getStorage("taskList");
  taskList.forEach((task) => {
    // UI.DisplayFunctions.displayTask.displayByObj(task);
    _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"].DisplayFunctions.displayTask.displayInDates(task);
    _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"].DisplayFunctions.displayTask.displayInPriorities(task);
  });
  _modules_UI__WEBPACK_IMPORTED_MODULE_2__["default"].DisplayFunctions.refreshProjectsInForm();
});
